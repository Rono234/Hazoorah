...
(function() {
    ...
    function generateLevelBtns() {
        ...
        for (let i = 1; i <= totalLevels; i++) {
            ...
            // Determine stars from previous level (only if not level 1)
            const previousStars = levelInTown === 1 ? 1 : (townProgress[starKey]?.[levelInTown - 1] || 0);
            ...
            btn.addEventListener('click', () => {
                window.location.href = `puzzle.html?town=${town}&level=${levelInTown}`;
            });
